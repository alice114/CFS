...
public class Twitter {
	...
	private String twitter_consumer_key = "hbHTDmQNJf8Vll2gLQMRjX7iy";
	private String twitter_consumer_secret = "IzmcPPnHnsrk80X9Abteh5FTwgk5I4tmSXyeMfTiqufOGcbmsC";	
	...
	public JSONObject searchTweetsPopular(String q, String access_token, String access_token_secret)
	{
		JSONObject jsonresponse = new JSONObject();
		...
		String parameter_string = "count="+100+"&lang=en&oauth_consumer_key=" + twitter_consumer_key + "&oauth_nonce=" + oauth_nonce + "&oauth_signature_method=" + oauth_signature_method + 
			"&oauth_timestamp=" + oauth_timestamp + "&oauth_token=" + encode(oauth_token) + "&oauth_version=1.0&q=" + encode(q) + "&result_type=popular";	
		System.out.println("parameter_string=" + parameter_string);
		...
		System.out.println("authorization_header_string=" + authorization_header_string);
		 ...
		 try {
			 try {
				 ...
				 BasicHttpEntityEnclosingRequest request2 = new BasicHttpEntityEnclosingRequest("GET", twitter_endpoint_path + "?count="+100+"&lang=en&result_type=popular&q=" + encode(q));
				 request2.setParams(params);
		...
		System.out.println("authorization_header_string=" + authorization_header_string);
		 ...
		 try {
			 try {
				 ...
				 // the following line adds 3 params to the request just as the parameter string did above. They must match up or the request will fail.
				 BasicHttpEntityEnclosingRequest request2 = new BasicHttpEntityEnclosingRequest("GET", twitter_endpoint_path + "?count="+100+"&lang=en&result_type=mixed&q=" + encode(q));
				 request2.setParams(params);
				 request2.addHeader("Authorization", authorization_header_string); // always add the Authorization header
				 httpexecutor.preProcess(request2, httpproc, context);
				 HttpResponse response2 = httpexecutor.execute(request2, conn, context);
	...
	public static void main(String[] args) {
		...
		String authenicateURL = "https://api.twitter.com/oauth/authenticate?oauth_token=" + oauth_token;
		System.out.println(authenicateURL);
		...
		try {
			...
			twitter.updateStatusWithMedia(access_token, access_token_secret, "Hahaha!", new File("/Users/luchen/Desktop/111.jpg"));
